...
SET ANSI_NULLS ON
GO
CREATE PROCEDURE [dbo].[staging_update_next_available_data]
AS
BEGIN
...
--set @build_dt_start = '20150401'

--set @build_dt_end ='20150602'
...
SET @Build_counter = convert(varchar(8), DATEADD(WEEK,1,cast(@Build_counter as datetime)), 112)
END;
